...
python pyCorpVRT.py "LKeyColumns.extend([2])" "LValueColumns.extend([1])" "LIndexColumns.extend([2,1])" "LFlags.extend(['fileVRT2posTemplates','dict2dstr'])" < pyCorpVRT_in_BNC1994-10k.vrt > pyCorpVRT_out_BNC1994-10k.txt
python pyCorpVRT.py "LKeyColumns.extend([2])" "LValueColumns.extend([1])" "LIndexColumns.extend([2,1])" "LFlags.extend(['fileVRT2posTemplates','dict2dstr'])" < pyCorpVRT_in_canada2018.vrt > pyCorpVRT_out_canada2018.txt
